...
// Delete.java
//
// Delete a country in CIFP section
//
...
@WebServlet(description = "Delete a country in CIFP section", urlPatterns = { "/api/cifp/country/delete" })

public class Delete extends HttpServlet {

	private static final long serialVersionUID = FmtTool.getSerialVersionUID();
	private static final String msgHead = "/api/cifp/country/delete: ";
